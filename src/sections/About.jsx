                ...
                <div className="xl:col-span-1 xl:row-span-3">
                    <div className="grid-container">
                        ...
                        <div>
                            ...
                            <p className="grid-subtext">With 3 years design and 7 months of full-stack development, I have honed my skills in frontend and backend development with a focus in animated websites.</p>
                        </div>
                    </div>
                </div>
