                ...
                <div className="xl:col-span-1 xl:row-span-3">
                    <div className="grid-container">
                        ...
                        <div>
                            ...
                            <p className="grid-subtext">With 3 years of design and 7 months of full-stack development experience, I have honed my skills in frontend and backend development with a focus in animated websites.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-span-1 xl:row-span-4">
                    <div className="grid-container">
                        ...
                        <div>
                            ...
                            <p className="grid-subtext">I'm based in Melbourne, Australia, I am open to opportunities in A & NZ.</p>
                            ...
                            <p className="grid-subtext text-center">Contact me</p>
                                <div className="copy-container" onClick={handleCopy}>
                                    <img src={hasCopied ? 'assets/tick.svg' : 'assets/copy.svg'} alt="copy" />
                                        <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">mark.kats.career@gmail.com</p>
                                </div>
                        </div>
                    </div>
                </div>
